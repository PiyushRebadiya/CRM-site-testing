...
// function InquriryCompltedChart({ completeinquiry }) {
//     // React.useEffect(() => {
//     //     if (insertChartData) {
...
//     //   const completedinquiry = inquiryData.filter((item=>item.TaskStatus=='Complete'))
//     const completedinquiry = completeinquiry.filter((item) => item.TaskStatus == 'Complete')
//     // console.log(completedinquiry, 'comp[oermertp')
//     useEffect(() => {
...
//                     </tbody>
//                 </Table>
//                 {/* <h5 style={{ fontSize: '1.3rem' }}> <i>Total Completed Inquiry-{completedinquiry.length}</i></h5> */}
//             </div>
//         </div>
//     );
// }

// export default InquriryCompltedChart;
...
//   const RunningTask = taskchartdata.filter((item) => item.TaskStatus === 'InProgress');
  const CompletedTask = completeinquiry.filter((item) => item.TaskStatus === 'Complete');
  ...
  useEffect(() => {
    ...
    setChartOptions({
      dynamicChartData,
      dynamicChartOptions,
      totalTasks: completeinquiry.length,

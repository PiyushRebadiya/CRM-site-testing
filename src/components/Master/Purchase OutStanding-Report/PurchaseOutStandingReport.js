...
import PurchaseOutStandingTable from './PurchaseOutStandingTable';
...
const PurchaseOutStandingReport = () => {
    ...
    const OutstandingList = async () => {
        try {
            const res = await axios.get(URL + `/api/Transation/OutStandingReportPurchase?CompanyID=${companyid}&PartyId=${selectedparty}`, {
            ...
            <div className='content-wrapper'>
                <section className="content-header">
                    ...
                    <div className="header-title">
                        <h1>Purchase OutStanding Report</h1>
                    ...
                    <div className="row">
                        <div className="col-xl-12 col-lg-12 pinpin">
                            <div className="card lobicard" data-sortable="true">
                                ...
                                <div className='p-3' >
                                    <PurchaseOutStandingTable data={data} />
                                </div>
                            </div>
                        </div>
                    </div>

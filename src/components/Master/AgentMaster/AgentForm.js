...
const validationSchema = Yup.object().shape({
  partyname: Yup.string().required("Agent Name is required"),
...
const PartyForm = ({ getAgentData, onHide, rowData, fetchData }) => {
  // const PartyForm = ({ getAgentData, onHide, rowData, fetchData, errorData, reset_Data }) => {
  ...
  useEffect(() => {
    if (rowData) {
      setPartyId(rowData.AgentId);
      setCompanyName(rowData.CompanyId);
      setPartyName(rowData.AgentName);

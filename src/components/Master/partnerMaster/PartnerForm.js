...
const PartnerForm = ({ getPartnerData, onHide, rowData, fetchData }) => {
  ...
  useEffect(() => {
    if (rowData) {
      ...
      setPartnerName(rowData.PartnerName);
                  ...
                  <div className="col-sm-12">
                    ...
                    <Tabs  defaultActiveKey="1" transition={true}>
                      <TabPane
                        key="1"
                        tab={<div>
                          <span className={errors.partnerName ? 'text-danger' : '' || errors.mobile1 ? 'text-danger' : ''}>Personal Details</span>{' '}
                          {errors.partnerName && errors.mobile1 && (
